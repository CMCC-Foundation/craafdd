...
MAX_SNAPSHOTS=3 #3 #2
INTER_SNAPSHOTS_INTERVAL_SECONDS=3 #$(($MMGETSTATE_ELAPSED_SECONDS*$SAFETY_SNAPSHOTS_INTERVAL_MULTIPLIER))
...
PHYSICAL_QUORUM_CONDITION=0 #1 #0 #1 #0
...
SLEEPING_SECONDS_AFTER_LFR_ERROR=20
